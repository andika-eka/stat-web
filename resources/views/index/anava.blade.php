        ...
        <div class="col col col-lg-2 text-center">
            <div class="card border-primary bg-dark mb-3 "
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-outline-success" data-toggle="modal" data-target="#exampleModal4"> <i class="fas fa-file-import"></i> import</a>
                    <a href="/exportAnava" class="btn btn-outline-success" ><i class="fas fa-file-export"></i>Export</a>
...
<div class="modal fade" id="exampleModaldel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form name="delete" action="/anava" method="POST">
